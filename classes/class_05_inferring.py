...
def execute():
    print("Welcome to class 05: Inferring")
    print("------------------------------")
    ...
    # Asking the model to do multiple tasks at the same time
    prompt = f"""
    Identify the following items from the review text:
    ...
    # Making the model to infer the multiples topics in a text
    story = """
